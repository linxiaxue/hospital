  ...
  <div class="base">
    ...
    <el-table :data="nurse">
      ...
      <el-table-column prop="ope" label="操作" align="center">
        <template slot-scope="scope">
          <router-link to="/hnurse/viewWnurse/viewPatient">
            <el-button type="button" v-on:click="mark(scope.row.userID)">查看病人信息</el-button>
          </router-link>
        </template>
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods:{
      nurses(){
        ...
        this.$axios.post('/hnurse/viewWnurse',{
          userID: cookieMy
        })
          .then(resp=>{
      ...
      mark(id){
        ...
        this.$router.replace({path: '/hnurse/viewNurse/viewPatient'});
      },
    }
  }
</script>
